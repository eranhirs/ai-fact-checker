# AI Overview Fact Checker

A Chrome extension that helps users verify claims in Google's AI Overview by checking them against source citations using Gemini.
...
1. Select any text from an AI Overview
